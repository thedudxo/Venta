...
partial class Concurrent_Send_Exception
{
    class Exception_during_event
{
        ...
        [Test]
        public void Resending_an_event_within_a_caught_exception_block_does_not_cause_eventSender_to_throw_a_concurrent_send_exception()
        {
            static void Act()
            {
                try
